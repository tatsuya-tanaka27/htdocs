...
<html lang="ja">
    ...
    <body>
        <form method="post" action="update.php">
            ...
            <span>性別：</span><input type="text" name="sex" value="<?php echo $_SESSION['user_data']['pass'] ?>"><br>
            <span>電話番号</span><input type="text" name="tel" value="<?php echo $_SESSION['user_data']['pass'] ?>"><br>
            <span>生まれ年（西暦）：</span><input type="text" name="birth" value="<?php echo $_SESSION['user_data']['pass'] ?>"><br>
