...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if(chackUpdateParam($upass, $usex, $utel, $ubirth)){
            ...
            $stmt = $pdo->prepare('update kaiin3 set pass=:pass, sex=:sex, post=:post, tel=:tel 
                where id=:id');
...
<html lang="ja">
    ...
    <body>
        <form method="post" action="update.php">
            ...
            <span>郵便番号：</span><input type="text" name="birth" value="<?php echo $_SESSION['user_data']['birth'] ?>"><br>
