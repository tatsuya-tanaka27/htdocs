...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if(chackRegistrationParam($pmail, $ppass, $psex, $ppost, $ptel)){
            ...
            if($checkRow != null){
                ...
                $stmt2 = $pdo->prepare('insert into kaiin2(mail, pass, sex, post, tel) 
                    VALUES(:mail, :pass, :sex, :post,:tel)');
                ...
                $stmt3 = $pdo->prepare('select * from kaiin2 where mail = :mail and pass = :pass;');
